...
import com.example.simplegallery2.models.DataImage
import com.example.simplegallery2.models.ImageDataResponse
import com.example.simplegallery2.retrofit.RetrofitClient
...
class MediaActivity : SimpleActivity(), MediaOperationsListener {
    ...
    private fun gotMedia(media: ArrayList<ThumbnailItem>, isFromCache: Boolean) {
        ...
        if (!isFromCache) {
            val mediaToInsert = (mMedia).filter {
                it is Medium && it.deletedTS == 0L
            }.map {
                it as Medium
            }
